...
time_wanted=[dt.datetime(2014,11,3,23,59,59,0),dt.datetime(2014,12,26,23,59,59,0)]
url=['http://basin.ceoe.udel.edu/thredds/dodsC/ModisAqua/2014/aqua.2014307.1103.235959.D.L3.modis.NAT.v09.1000m.nc4','http://basin.ceoe.udel.edu/thredds/dodsC/ModisAqua/2014/aqua.2014360.1226.235959.D.L3.modis.NAT.v09.1000m.nc4']
...
qk=axes[0,0].quiverkey(Q,0.1,0.5,0.5, r'$0.1pa$', fontproperties={'weight': 'bold'},zorder=1)
...
qk=axes[0,1].quiverkey(Q,0.1,0.4,0.5, r'$0.1m/s$', fontproperties={'weight': 'bold'},zorder=1)
...
Q=axes[1,1].quiver(xxb,yyb,ub2.T,vb2.T,scale=5.)
qk=axes[1,1].quiverkey(Q,0.1,0.4,0.5,r'$0.1pa$', fontproperties={'weight': 'bold'})
...
for i in range(len(url)):
    ...
    #t=axes[0,i].set_title(str(time_wanted[i].strftime("%d-%b-%Y %H:%M")),loc='center')  
...
cb.set_label('Degree C')
"""
plt.savefig('speedwind&SST1226',dpi=400,bbox_inches="tight")